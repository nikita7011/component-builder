  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto bg-background/50 backdrop-blur-sm rounded-2xl border border-border overflow-hidden">
        ...
        <div className="hidden md:block relative overflow-hidden h-[500px] -mb-[100px]">
          <div 
          ...
          >
            {images.map((image, index) => {
              ...
              const yOffset = isHovered ? -180 : isOtherHovered ? 40 : -staggerOffset
              ...
              return (
                ...
                >
                  <div
                    className="relative aspect-[4/3] w-64 md:w-80 lg:w-96 rounded-2xl overflow-hidden transition-all duration-500 bg-gray-900 border border-white/10"
                    style={{
                      boxShadow: isHovered 
                        ? "0 25px 50px -12px rgba(0, 0, 0, 0.5), 0 0 20px rgba(139, 92, 246, 0.3)"
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
                      <p className="text-white font-bold text-lg">{image.title || image.alt}</p>
                    </div>
                  </div>
                </motion.div>
              )
