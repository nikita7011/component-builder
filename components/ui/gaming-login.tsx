            ...
            <div className="mb-8 text-center">
                ...
                <div className="text-white/80 flex flex-col items-center space-y-1">
                    <span className="relative group cursor-default">
                        ...
                        <span className="relative inline-block animate-pulse">Your component adventure awaits</span>
                    </span>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                    ...
                    className={`w-full py-3 rounded-lg ${isSuccess
                            ? 'bg-green-500 animate-[bounce_0.5s_ease-in-out_infinite]'
                ...
                >
                    {isSubmitting ? 'Logging in...' : 'Enter Builder'}
                </button>
            </form>
